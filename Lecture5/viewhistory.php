...
<html>
<head>
    <title>History Absence</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
        <h1>History Absence<h1>
            <table class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Student Long</th>
                        <th class="text-center">Student Lat</th>
                        <th class="text-center">Student Distance</th>
